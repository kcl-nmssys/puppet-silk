...
2. [Setup - The basics of getting started with silk](#setup)
    * [What silk affects](#what-silk-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with silk](#beginning-with-silk)
